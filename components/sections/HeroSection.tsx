            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="sm:hidden mt-4 rounded-lg bg-background border border-white/20 divide-y divide-white/10">
                    {stats.map((stat, i) => {
                  ...
                  <div className="hidden sm:grid grid-cols-3 gap-2 md:gap-3 mt-4 overflow-visible">
                    {stats.map((stat, i) => {
                      const Icon = stat.icon;
                      return (
                        <div key={i} className="group relative z-20 hover:z-[220] rounded-lg p-3 md:p-4 bg-background border border-white/20 overflow-visible" style={{ minHeight: '56px' }}>
                          <div className="flex items-center justify-between gap-2">
