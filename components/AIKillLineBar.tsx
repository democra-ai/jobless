              ...
              {showCalc && (
                <>
                  ...
                  <motion.div
                    ...
                    className="hidden sm:block absolute top-full right-0 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 mt-3 z-[200] w-[calc(100vw-2rem)] max-w-[400px] rounded-xl border border-surface-elevated/50 p-4 sm:p-5 text-left"
                    style={{
