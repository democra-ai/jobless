...
const DIMENSION_LEARNABILITY: QuizDimension = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { en: 'Almost all confidential or only in people\'s heads', zh: '几乎都是内部机密或只存在脑子里，外面查不到', ja: '20%未満、本の知識だけじゃ表面をなぞる程度', ko: '20% 미만 — 책에 나오는 건 빙산의 일각입니다', de: 'Weniger als 20 % — Buchwissen kratzt nur an der Oberfläche' },
        { en: 'Mostly confidential, some basics are public', zh: '大部分对外保密，少量基础知识公开', ja: '30〜40%くらい、役には立つけど全然足りない', ko: '대략 30-40% — 도움은 되지만 턱없이 부족합니다', de: 'Etwa 30–40 % — nützlich, aber bei Weitem nicht ausreichend' },
        { en: 'Some available online, some internal', zh: '一部分网上能找到，一部分是内部积累', ja: '50〜60%くらい、基礎は押さえられる', ko: '대략 50-60% — 기초는 잡을 수 있습니다', de: 'Etwa 50–60 % — eine solide Grundlage' },
        { en: 'Most knowledge has public resources', zh: '大部分有公开资料可学', ja: '70〜80%くらい、大部分は資料から学べる', ko: '대략 70-80% — 대부분 자료에서 배울 수 있습니다', de: 'Etwa 70–80 % — das meiste lässt sich aus Fachliteratur lernen' },
        { en: 'Tons of tutorials, standards, and cases online', zh: '网上基本都有，教程规范案例一抓一大把', ja: '90%以上、本でほぼ全部カバーできる', ko: '90% 이상 — 책에 거의 다 나와 있습니다', de: 'Über 90 % — Bücher decken fast alles ab' },
      ],
    },
    {
      id: 'Q3',
...
const DIMENSION_EVALUATION: QuizDimension = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { en: 'Not at all — standard operations only', zh: '完全不需要，执行标准操作', ja: 'まったく必要ない、決められた手順通りにやるだけ', ko: '전혀 필요 없습니다 — 정해진 표준 절차대로 하면 됩니다', de: 'Gar nicht — Standardabläufe ausführen genügt' },
        ...
        { en: 'Half standards, half taste', zh: '一半靠规范标准，一半靠品味', ja: '半分は規格や基準に従い、半分はセンスや感覚で判断', ko: '절반은 규정과 기준, 절반은 감각과 취향입니다', de: 'Zur Hälfte nach Normen und Standards, zur Hälfte nach Geschmack und Gefühl' },
...
const DIMENSION_RISK: QuizDimension = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { en: 'Can always undo/fix, no pressure', zh: '随时可以撤回修改，没压力', ja: '絶対にダメ、一発で正解を出さないといけない', ko: '절대 안 됩니다 — 반드시 한 번에 정확히 해야 합니다', de: 'Auf keinen Fall — es muss beim ersten Mal sitzen' },
        { en: 'Most errors can be fixed after the fact', zh: '大部分错误都能事后弥补', ja: 'ほとんどできない、失敗のコストが高すぎる', ko: '거의 안 됩니다 — 실수 비용이 너무 큽니다', de: 'Selten — die Kosten eines Fehlers sind zu hoch' },
        { en: 'Some can be fixed, some can\'t', zh: '有些能补救有些不能', ja: '試行錯誤できる工程もあれば、できない工程もある', ko: '일부 단계는 시행착오가 가능하고, 일부는 안 됩니다', de: 'Bei manchen Schritten ist Ausprobieren möglich, bei anderen nicht' },
        { en: 'Most errors are hard to reverse once made', zh: '大部分错误犯了就很难挽回', ja: 'だいたいの場面でトライ＆エラーや素早い改善が推奨される', ko: '대부분 시도와 빠른 반복을 권장합니다', de: 'Meistens wird Experimentieren und schnelles Iterieren sogar gefördert' },
        { en: 'Once wrong, almost impossible to fix', zh: '一旦出错几乎无法补救', ja: '仕事全体が実験と調整の連続そのもの', ko: '업무 방식 자체가 끊임없는 실험과 조정입니다', de: 'Die gesamte Arbeitsweise IST ständiges Experimentieren und Anpassen' },
      ],
    },
    {
      id: 'Q13',
      ...
      options: [
        { en: 'No barriers at all — anyone can do it', zh: '完全没有门槛，谁都可以做', ja: '法律で明確に禁止されている、絶対に無理', ko: '법으로 명확히 금지되어 있습니다 — 절대 불가능합니다', de: 'Gesetzlich ausdrücklich verboten — unmöglich' },
        { en: 'Some basic requirements but low barrier', zh: '有一些基本要求但门槛很低', ja: '法的にグレーゾーンが大きくて、制約も多い', ko: '법적으로 큰 회색지대와 제약이 있습니다', de: 'Erhebliche rechtliche Grauzonen und Einschränkungen' },
        { en: 'Requires certain certifications or training', zh: '需要一定的认证或培训资质', ja: '法律で制限される部分もあれば、されない部分もある', ko: '일부 단계에는 법적 제한이 있고, 일부는 없습니다', de: 'Manche Schritte unterliegen rechtlichen Beschränkungen, andere nicht' },
        { en: 'Strict licensing and industry regulation', zh: '有严格的执照和行业监管', ja: '法的にはほぼ障壁がない', ko: '법규상 장벽이 거의 없습니다', de: 'Im Wesentlichen keine regulatorischen Hürden' },
        { en: 'Must hold license to practice — violations are prosecuted', zh: '必须持证上岗，违规会被追责', ja: 'まったく制限なし、むしろ政策がAI活用を後押ししている', ko: '아무런 제한이 없고, 오히려 정책적으로 AI 도입을 장려합니다', de: 'Keinerlei Einschränkungen — die Politik fördert KI-Einsatz sogar aktiv' },
      ],
    },
    {
      id: 'Q14',
    ...
    },
    {
      ...
      options: [
        { en: 'Totally fine — nobody cares who/what does it', zh: '完全可以，没人在乎是谁做的', ja: 'まったく問題ない、誰がやっても気にしない', ko: '전혀 문제없습니다 — 누가 하든 상관없어합니다', de: 'Völlig in Ordnung — es interessiert niemanden, wer es macht' },
        { en: 'Most people wouldn\'t mind', zh: '大部分人不介意', ja: 'ほとんどの人は気にしない', ko: '대부분 개의치 않습니다', de: 'Die meisten hätten nichts dagegen' },
        { en: 'Mixed feelings — some OK, some uncomfortable', zh: '看情况，有人OK有人不舒服', ja: '人による、受け入れる人もいれば抵抗がある人もいる', ko: '경우에 따라 다릅니다 — 수용하는 사람도, 불편해하는 사람도 있습니다', de: 'Kommt darauf an — manche akzeptieren es, manche nicht' },
  ...
  questions: [
    {
      ...
      options: [
        { en: 'Purely price/efficiency — cheapest wins', zh: '纯粹看价格效率，谁便宜找谁', ja: '純粋に価格と効率、一番安いところに頼む', ko: '순전히 가격과 효율 — 가장 저렴한 곳을 찾습니다', de: 'Rein nach Preis und Effizienz — der Günstigste bekommt den Zuschlag' },
        { en: 'Mainly skills/qualifications, no personal preference', zh: '主要看能力资质，对谁没偏好', ja: '主にスキルや資格を見ていて、誰かへのこだわりはない', ko: '주로 역량과 자격을 보고, 특정 사람에 대한 선호는 없습니다', de: 'Hauptsächlich nach Kompetenz — ohne persönliche Präferenz' },
        { en: 'Skills matter, but also working rapport', zh: '能力重要，也考虑合作默契', ja: '能力も大事だけど、相性や信頼関係も考慮する', ko: '역량도 중요하지만, 협업 궁합과 신뢰도 고려합니다', de: 'Kompetenz ist wichtig, aber auch Vertrauen und gute Zusammenarbeit zählen' },
        { en: 'Many clients stay because of the relationship', zh: '很多客户因为关系好才长期合作', ja: '長い付き合いがあるから続けている、というお客さんが多い', ko: '오랜 관계 때문에 계속 함께하는 고객이 많습니다', de: 'Viele Kunden bleiben wegen der langjährigen Beziehung' },
        { en: 'Clients only work with me — would leave if I\'m gone', zh: '客户只认我，换人就不干了', ja: 'お客さんは自分じゃないとダメ、担当が変わったら取引終了', ko: '고객이 저라는 사람만 믿고, 담당자가 바뀌면 거래를 끊습니다', de: 'Kunden arbeiten nur mit MIR — wenn ich gehe, wechseln sie auch' },
      ],
    },
    {
      id: 'Q17',
      ...
      options: [
        { en: 'None at all — only care if I can do the job', zh: '完全没有，只看我能不能干好活', ja: '非常に難しい、半年以上かかるか見つからないかもしれない', ko: '매우 어렵습니다 — 6개월 이상, 어쩌면 못 찾을 수도 있습니다', de: 'Sehr schwierig — vielleicht über 6 Monate, möglicherweise gar nicht' },
        { en: 'Very few know me, vast majority look at skills', zh: '极少数人认我，绝大部分看能力', ja: 'けっこう大変、数ヶ月はかかる', ko: '꽤 어렵습니다 — 몇 달은 걸립니다', de: 'Ziemlich schwierig — einige Monate wären nötig' },
        { en: 'Some come for me, more come for skills', zh: '有一部分冲我来的，更多看能力', ja: '1〜2ヶ月あれば適任者が見つかる', ko: '한두 달이면 적합한 사람을 찾을 수 있습니다', de: 'In 1–2 Monaten ließe sich jemand Passendes finden' },
        { en: 'Quite a few come for me — some level of fame', zh: '不少人冲我来的，有一定知名度', ja: '2〜3週間で採用できる', ko: '2-3주면 채용할 수 있습니다', de: 'In 2–3 Wochen wäre jemand eingestellt' },
        { en: 'I AM the brand — people come specifically for me', zh: '我本身就是品牌，就是冲我来的', ja: 'すぐに代わりが見つかる', ko: '즉시 대체자를 구할 수 있습니다', de: 'Sofort — ein Ersatz wäre umgehend verfügbar' },
      ],
    },
    {
      id: 'Q18',
      ...
      options: [
        { en: 'Not at all — can do everything remotely', zh: '完全不用，在哪都能远程完成', ja: 'まったく不要、どこからでもリモートで完結する', ko: '전혀 그렇지 않습니다 — 어디서든 원격으로 가능합니다', de: 'Überhaupt nicht — alles lässt sich von überall aus remote erledigen' },
        { en: 'Occasionally need to be on-site, mostly remote', zh: '偶尔需要到场，大部分可远程', ja: 'たまに現場に行く必要があるけど、ほとんどリモートでOK', ko: '가끔 현장에 가야 하지만, 대부분 원격으로 됩니다', de: 'Gelegentlich muss ich vor Ort sein, aber größtenteils remote' },
        { en: 'Half on-site, half remote', zh: '一半到场，一半远程', ja: 'だいたい半分は現場、半分はリモート', ko: '대략 절반은 현장, 절반은 원격입니다', de: 'Etwa zur Hälfte vor Ort, zur Hälfte remote' },
        { en: 'Mostly need to be physically present', zh: '大部分时候必须到场', ja: 'ほとんどの場合、現場にいないといけない', ko: '대부분 현장에 있어야 합니다', de: 'Ich muss die meiste Zeit vor Ort sein' },
        { en: 'Must be physically there in person', zh: '必须本人在现场用身体完成', ja: '必ず本人がその場にいて、体を使って仕事をする必要がある', ko: '반드시 본인이 현장에서 직접 몸으로 해야 하는 일입니다', de: 'Ich muss persönlich anwesend sein und die Arbeit körperlich ausführen' },
      ],
    },
    {
      id: 'Q19',
    ...
    },
    {
      ...
      options: [
        ...
        { en: 'A bit surprised but basically OK', zh: '有点意外但基本能接受', ja: 'ちょっと驚かれるけど、基本的には許容範囲', ko: '좀 놀라겠지만 대체로 받아들입니다', de: 'Etwas überrascht, aber grundsätzlich akzeptabel' },
        { en: 'Feels like reduced value, but still somewhat OK', zh: '觉得打了折扣，但还算认可', ja: '価値が下がった気がするけど、まあ認めてもらえる', ko: '가치가 좀 떨어진다고 느끼지만, 그래도 인정은 합니다', de: 'Würden den Wert als gemindert empfinden, es aber noch hinnehmen' },
        { en: 'Clearly feels less valuable and dissatisfied', zh: '明显觉得价值降低、不满意', ja: '明らかに価値が下がったと感じて、不満を持たれる', ko: '확실히 가치가 낮아졌다고 느끼고 불만스러워합니다', de: 'Würden deutlich das Gefühl haben, dass der Wert gesunken ist — unzufrieden' },
        { en: 'Completely unacceptable — feels deceived', zh: '完全无法接受，觉得被欺骗了', ja: '絶対に受け入れられない、騙されたと感じる', ko: '절대 받아들일 수 없습니다 — 속았다고 느낄 것입니다', de: 'Absolut inakzeptabel — sie würden sich getäuscht fühlen' },
      ],
    },
  ],
};
